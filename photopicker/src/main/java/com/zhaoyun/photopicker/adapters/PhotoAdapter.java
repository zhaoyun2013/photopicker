package com.zhaoyun.photopicker.adapters;
...
import com.zhaoyun.photopicker.PhotoPickerActivity;
import com.zhaoyun.photopicker.R;
import com.zhaoyun.photopicker.beans.Photo;
import com.zhaoyun.photopicker.utils.ImageLoader;
...
public class PhotoAdapter extends BaseAdapter {
    ...
    private View.OnClickListener mOnPhotoCheck;
    private PhotoCheckedCallBack mPhotoCheckedCallBack;
    ...
    public void setPhotoCheckCallBack(PhotoCheckedCallBack callback) {
        mPhotoCheckedCallBack = callback;
    }
    ...
    public void setSelectedPhotos(List<String> data){
        mSelectedPhotos = data;
    }
    ...
    private void initMultiMode() {
        ...
        mOnPhotoCheck = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String path = ((View)v.getParent()).findViewById(R.id.imageview_photo).getTag().toString();
                if(mSelectedPhotos.contains(path)) {
                    ((View)v.getParent()).findViewById(R.id.mask).setVisibility(View.GONE);
                    ((View)v.getParent()).findViewById(R.id.checkmark).setSelected(false);
                    ...
                    ((View)v.getParent()).findViewById(R.id.mask).setVisibility(View.VISIBLE);
                    ((View)v.getParent()).findViewById(R.id.checkmark).setSelected(true);
                }
                if(mPhotoCheckedCallBack != null) {
                    mPhotoCheckedCallBack.onPhotoChecked();
                }
            }
        };
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(getItemViewType(position) == TYPE_CAMERA) {
            ...
            if(mSelectMode == PhotoPickerActivity.MODE_MULTI) {
                holder.selectView.setOnClickListener(mOnPhotoCheck);
//                holder.photoImageView.setOnClickListener(mOnPhotoClick);
     ...
     * 多选时，点击多选框接口
     */
    public interface PhotoCheckedCallBack {
        void onPhotoChecked();
    }
}
